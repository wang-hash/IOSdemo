...
//            self.titleLabel.numberOfLines = UI(2);
        ...
        [self.contentView addSubview: ({
//            _commentLabel = [[UILabel alloc] initWithFrame:UIRect(20, 70, 50, 20)];
             _commentLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 70, 50, 20)];
//            _commentLabel.backgroundColor = [UIColor redColor];
            _commentLabel;
        })];
        [self.contentView addSubview: ({
//            _sourceLabel = [[UILabel alloc] initWithFrame:UIRect(100,70,50,20)];
...
//    _sourceLabel.frame = CGRectMake(_commentLabel.frame.origin.x + _commentLabel.frame.size.width + UI(15), _sourceLabel.frame.origin.y, _sourceLabel.frame.size.width, _sourceLabel.frame.size.height);
...
//        _timeLabel.frame = CGRectMake(_sourceLabel.frame.origin.x + _sourceLabel.frame.size.width + UI(15), _timeLabel.frame.origin.y, _timeLabel.frame.size.width, _timeLabel.frame.size.height);
